...
namespace PSSharp
{
    ...
    public sealed class PSCodePropertySetImplementationAttribute : PSExtendedTypeDataAttribute
    {
        /// <summary>
        ...
        public PSCodePropertySetImplementationAttribute(Type type, string propertyName)
        ...
        /// <param name="propertyName">The name of the code property.</param>
        public PSCodePropertySetImplementationAttribute(string typeName, string propertyName)
        {
